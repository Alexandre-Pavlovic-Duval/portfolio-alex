...
import { faLinkedin, faGithub, faPadlet } from '@fortawesome/free-brands-svg-icons';
                    ...
                    <div className={styles.contactContainer}>
                        ...
                        <div className={styles.contactInformation}>
                            ...
                            <div className={styles.emailInformation}>
                                <span>{phone}</span><span className={styles.phone}>+33 6 67 67 22 67</span>
                                <br></br>
                                <span>{email}</span><span className={styles.mail}>alexandre.pavlovic.duval@gmail.com</span>
                            </div>
